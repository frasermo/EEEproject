###########################################################################
## Makefile generated for component 'final_lockin'. 
## 
## Makefile     : final_lockin.mk
## Generated on : Sun Nov 07 18:24:48 2021
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/final_lockin.out
...
PRODUCT_NAME              = final_lockin
MAKEFILE                  = final_lockin.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2021a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2021a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/FRASER~1/DOCUME~1/MATLAB/Examples/R2021a/matlab/PULSEG~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = TI C28x
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/final_lockin.out
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/final_lockin_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(MATLAB_ROOT)/toolbox/dsp/include -I$(MATLAB_ROOT)/toolbox/dsp/extern/src/export/include/src -I$(MATLAB_ROOT)/toolbox/dsp/extern/src/export/include -I$(MATLAB_ROOT)/toolbox/shared/dsp/vision/matlab/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021a/toolbox/target/SUPPOR~1/tic2000/inc -I$(MATLAB_ROOT)/toolbox/shared/can/src/scanutil -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021a/toolbox/target/SUPPOR~1/tic2000/src -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021a/toolbox/shared/SUPPOR~1/tic2000/src -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021a/toolbox/shared/SUPPOR~1/tic2000/inc -IC:/ti/CONTRO~1/DEVICE~1/F2837xD/v190/F2837X~1/include -IC:/ti/CONTRO~1/DEVICE~1/F2837xD/v190/F2837X~4/include -IC:/ti/CONTRO~1/DEVICE~1/F2837xD/v190/F2837X~1 -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021a/toolbox/target/shared/EXTERN~1/include -I$(MATLAB_ROOT)/toolbox/rtw/targets/common/can/blocks/tlc_c
...
DEFINES_STANDARD = -DMODEL=final_lockin -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_c2000DAC.obj MW_c28xx_csl.obj MW_c28xx_board.obj MW_c28xx_xbar.obj MW_c28xx_adc.obj final_lockin.obj final_lockin_data.obj c2837xDBoard_Realtime_Support.obj MW_c28xGlobalInterrupts.obj F2837xD_CpuTimers.obj F2837xD_DefaultISR.obj F2837xD_GlobalVariableDefs.obj F2837xD_PieCtrl.obj F2837xD_PieVect.obj F2837xD_SysCtrl.obj F2837xD_usDelay.obj F2837xD_CodeStartBranch.obj F2837xD_Dma.obj F2837xD_Adc.obj F2837xD_Gpio.obj F2837xD_Ipc_Driver_Lite.obj F2837xD_Emif.obj profiler_Support.obj MW_c28xGPIO.obj c2837xDSchedulerTimer0.obj ext_svr_c2000.obj updown_c2000.obj ext_work_c2000.obj rtiostream_utils_c2000.obj rtiostream_interface_c2000.obj rtiostream_serial_c28x_ext.obj datamodify.obj daemon_checksum.obj
...
%.obj : $(START_DIR)/final_lockin_ert_rtw/%.cla
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/final_lockin_ert_rtw/%.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/final_lockin_ert_rtw/%.asm
	$(AS) $(ASFLAGS) --output_file="$@" "$<"


%.obj : $(START_DIR)/final_lockin_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) --output_file="$@" "$<"
...
MW_c2000DAC.obj : C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/target/supportpackages/tic2000/src/MW_c2000DAC.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_csl.obj : $(START_DIR)/final_lockin_ert_rtw/MW_c28xx_csl.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_board.obj : $(START_DIR)/final_lockin_ert_rtw/MW_c28xx_board.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_xbar.obj : $(START_DIR)/final_lockin_ert_rtw/MW_c28xx_xbar.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


MW_c28xx_adc.obj : $(START_DIR)/final_lockin_ert_rtw/MW_c28xx_adc.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


ert_main.obj : $(START_DIR)/final_lockin_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


final_lockin.obj : $(START_DIR)/final_lockin_ert_rtw/final_lockin.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


final_lockin_data.obj : $(START_DIR)/final_lockin_ert_rtw/final_lockin_data.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
...
ext_svr_c2000.obj : C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/target/supportpackages/tic2000/src/ext_svr_c2000.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


updown_c2000.obj : C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/target/supportpackages/tic2000/src/updown_c2000.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


ext_work_c2000.obj : C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/target/supportpackages/tic2000/src/ext_work_c2000.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rtiostream_utils_c2000.obj : C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/target/supportpackages/tic2000/src/rtiostream_utils_c2000.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rtiostream_interface_c2000.obj : C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/target/supportpackages/tic2000/src/rtiostream_interface_c2000.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


rtiostream_serial_c28x_ext.obj : C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/target/supportpackages/tic2000/src/rtiostream_serial_c28x_ext.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


datamodify.obj : C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/target/supportpackages/tic2000/src/datamodify.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"


daemon_checksum.obj : C:/ProgramData/MATLAB/SupportPackages/R2021a/toolbox/target/shared/externalmode_daemon/src/daemon_checksum.c
	$(CC) $(CFLAGS) --output_file="$@" "$<"
